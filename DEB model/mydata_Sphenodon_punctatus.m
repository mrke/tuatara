...
%%
function [data, txt_data, metadata] = mydata_Sphenodon_punctatus 
...
metadata.author   = {'Michael Kearney', 'Scott Jarvie', 'Alison Cree'};                              % put names as authors as separate strings:  {'author1','author2'} , with corresponding author in first place
...
data.ab = 250;      units.ab = 'd';    label.ab = 'age at birth';                bibkey.ab = 'Mitchell_et_al_2006';
  temp.ab = T_C + 20;  bibkey.ab = 'Mitchell_et_al_2006'; % K, temperature, based on ;
  % observed age at birth is frequently larger than ab, because of diapauzes during incubation
data.ap = data.ab+12*365;     units.ap = 'd';    label.ap = 'age at puberty';              bibkey.ap = 'Jarvie_unpub';
  temp.ap = T_C + 18.5;  bibkey.ap = 'Jarvie_unpub'; % K, temperature, based on simulation of Tb from 2000-2013 at Orford, see last lines of Sphenodon_punctatus.R;;
...
data.am = 100*365;     units.am = 'd';    label.am = 'life span';                   bibkey.am = 'Dawbin_1982';
  temp.am = T_C + 18.5;  bibkey.am = 'Jarvie_unpub'; % K, temperature, based on simulation of Tb from 2000-2013 at Stephens Island/Takapourewa, see last lines of Sphenodon_punctatus.R;;
...
data.Lb  = 4.92;   units.Lb  = 'cm';   label.Lb  = 'snout to vent length at birth';    bibkey.Lb  = 'Cree_unpub';
data.Lp  = 17.0;   units.Lp  = 'cm';   label.Lp  = 'snout to vent length at puberty';  bibkey.Lp  = 'Cree_1994';
data.Li  = 22.0;   units.Li  = 'cm';   label.Li  = 'ultimate snout to vent length';    bibkey.Li  = 'Jarvie_unpub';
data.Wdb = 4.27*0.3; units.Wdb = 'g';    label.Wdb = 'dry weight at birth';              bibkey.Wdb = 'Cree_unpub';
%find dry weight at puberty
data.Wdp = 163*0.3;   units.Wdp = 'g';    label.Wdp = 'dry weight at puberty';            bibkey.Wdp = 'Cree_1994';
data.Wdi = 357*0.3;   units.Wdi = 'g';    label.Wdi = 'ultimate dry weight';              bibkey.Wdi = 'Dawbin_1982';
data.Ri  = 10/(4*365);    units.Ri  = '#/d';  label.Ri  = 'maximum reprod rate';              bibkey.Ri  = 'Cree_1994';
  % for an individual of ultimate length Li 
  temp.Ri = T_C +  18.88;  bibkey.Ri = 'Jarvie_unpub'; % K, temperature, based on simulation of Tb from 2000-2013 at Stephens Island/Takapourewa, see last lines of Sphenodon_punctatus traits.R;
...
units.LW = {'cm', 'g'};     label.LW = {'time since birth', 'wet weight'};  bibkey.LW = 'Dawbin_1982';
 ...
 data.TO = [ ... temp (C), O2 consumption (ml/h.gwet) of 18.90108 g wet weight (5.67 g dry), based on 10th percentile of Scott's data
5   0.0016422
12	0.002366757
20	0.007695684
24	0.011011122
